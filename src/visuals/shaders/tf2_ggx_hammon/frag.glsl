...
float retroReflectiveDiffuse(float NdotV, float NdotL, float LdotH, float roughness) {
...
void main() {
    ...
    for (int i = 0; i < MAX_LIGHTS; ++i) {
        ...
        float diffuseBRDF = retroReflectiveDiffuse(NdotV, NdotL, LdotH, finalRoughness);
